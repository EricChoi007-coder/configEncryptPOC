package com.scl.tibcoreplacement.configpoc.utils.rsa;
    ...
    public String encrypt(String source) {
     ...
     //  BASE64Encoder encoder = new BASE64Encoder();
        ...
        try {
             ...
             * 执行加密操作
             */
            encryptSource = new String(Base64.getEncoder().encode(cipher.doFinal(bytes)));
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
